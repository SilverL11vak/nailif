...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (available) {
      setNextAvailable(`${t('widget.todayAt')} ${available.time}`);
    } else {
      ...
      if (tomorrowAvailable) {
        setNextAvailable(`${t('widget.tomorrowAt')} ${tomorrowAvailable.time}`);
      }
    }
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`flex items-center justify-between transition-all duration-300 ${
            ...
            <nav className="hidden lg:flex items-center gap-10">
              ...
              <button onClick={() => scrollToSection('pricing')} className="text-gray-600 hover:text-gray-900 transition-colors font-medium text-[15px]">{t('nav.pricing')}</button>
      ...
      <section id="gallery" className="py-20 lg:py-28" style={{ backgroundColor: colors.backgroundAlt }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl font-medium text-gray-900 mb-4 tracking-tight">{t('gallery.title')}</h2>
      ...
      <section id="pricing" className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl font-medium text-gray-900 mb-4 tracking-tight">{t('enhancements.title')}</h2>
            <p className="text-lg text-gray-500">{t('enhancements.subtitle')}</p>
          </div>
      ...
      <section className="py-20 lg:py-28" style={{ backgroundColor: colors.backgroundAlt }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-4xl font-medium text-gray-900 mb-4 tracking-tight">{t('team.title')}</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-sm text-gray-500 mb-2">{t('team.nailArtist')}</p>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 text-center">
              ...
              <p className="text-sm text-gray-500 mb-2">{t('team.spaExpert')}</p>
